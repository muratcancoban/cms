                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="form-content">
                                <textarea name="post_short_content"
                                          class="ckeditor"><?= post('post_short_content') ? post('post_short_content') : $row['post_short_content'] ?></textarea>
                            </div>
                        </li>
                        <li>
                            <label>Konu İçeriği</label>
                            <div class="form-content">
                                <textarea name="post_content" class="ckeditor" cols="30"
                        ...
                        <li>
                            ...
                            <div class="form-content">
                                ...
                                <p><!--eğer post varsa post_tags'ı ekrana yazdır (, koyulacak)-->
