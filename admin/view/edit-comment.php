<?php require admin_view('static/header') ?>
    ...
    <div class="box-">
        ...
        </div><!--post urlsini çekip yarum tarihi ve kullanıcı adı ile birlikte bilgilendirici metin bulunduruyor -->
                ...
                <li>
                    ...
                    <div class="form-content">
                        <input type="text" name="comment_name"
                               value="<?= post('comment_name') ? post('comment_name') : $row['comment_name'] //comment_name varsa post'ta onu yazacak yoksa row'daki comment_name gelecek?>">
                    </div>
                </li>
                <li>
